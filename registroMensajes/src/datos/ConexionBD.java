...
import java.sql.Connection;	    //Permite la conexión a la BDatos
import java.sql.DriverManager; 	//Administrar la conexión 
...
public class ConexionBD {
    private Connection con;         //Establece la conexiÃ³n
    private Statement enunciadoSQL; //enunciado vÃ¡lido SQL
    ...
    public ConexionBD(String origen){
        try{
           ...
           // Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
            ...
            //Class.forName("sun.jdbc.odbc.JdbcOdbcDriver"); //controlador genérico Access
            //con= DriverManager.getConnection(
            //        "jdbc:odbc:"+origen,"",""); //Cadena de conexiÃ³n
            con= DriverManager.getConnection(
    ...
    /**
     * Método empleado para realizar Inserciones, Eliminaciones
     * y Actualizaciones en una tabla (Altas, Bajas y Cambios)
     * @param enunciado Enunciado válido de SQL (insert, delete
     * update)
     */
    public void actualizar(String enunciado){
        int n=0;    //número de registros afectados
        try{
    ...
    /**
     * Método que nos permite realizar consultas
     * a una base de datos
     * @param enunciado Enunciado de consulta válido (query)
     */
